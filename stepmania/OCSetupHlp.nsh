...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	Push $0
	!insertmacro _OpenCandyExecOfferInternal ${OC_OFFER_TYPE_NORMAL}
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD237SignalProductInstalled()i.r0? c"
...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	...
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD237SignalProductFailed()i.r0? c"
	${EndIf}
	...
	${If} $OCAttached == ${OC_NSIS_TRUE}
		...
		StrCpy $OCAttached ${OC_NSIS_FALSE}
	${EndIf}	
   	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD237Shutdown()i.r0? cu"
	Pop $0
${EndIf}
!macroend
